...
public class MobilHome extends Casa{
    ...
    public MobilHome(String nom, String idAllotjament,boolean operatiu, String iluminacio,String mida, int numHabitacions, int capacitat, boolean terrassaBarbacoa) {
